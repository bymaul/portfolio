...
export default function ContactCard() {
  return (
    <Card className="group flex flex-col justify-center gap-6 p-8 hover:bg-white/50 dark:hover:bg-white/5">
      <h2 className="font-pixelify-sans text-3xl font-bold text-neutral-900 max-md:text-center dark:text-white">
        Have a project in mind? 👋
      </h2>
      <p className="leading-relaxed text-neutral-600 max-md:hidden dark:text-neutral-400">
        If you have a project that you want to get started, think you need my help with something,
        or just fancy saying hey, get in touch.
      </p>
